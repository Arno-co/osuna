...
#                           POST   /api/teams/:team_id/projects(.:format)                                                   api/projects#create {:format=>:json}
#      new_api_team_project GET    /api/teams/:team_id/projects/new(.:format)                                               api/projects#new {:format=>:json}
#     edit_api_team_project GET    /api/teams/:team_id/projects/:id/edit(.:format)                                          api/projects#edit {:format=>:json}
#          api_team_project GET    /api/teams/:team_id/projects/:id(.:format)                                               api/projects#show {:format=>:json}
#                           PATCH  /api/teams/:team_id/projects/:id(.:format)                                               api/projects#update {:format=>:json}
#                           PUT    /api/teams/:team_id/projects/:id(.:format)                                               api/projects#update {:format=>:json}
#                           DELETE /api/teams/:team_id/projects/:id(.:format)                                               api/projects#destroy {:format=>:json}
